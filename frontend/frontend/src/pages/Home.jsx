...
const Home = () => {
    ...
    const categories = [
        { name: 'Fashion', image: 'https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fit=crop&w=800&q=80', count: '500+ Products' },
        { name: 'Electronics', image: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?auto=format&fit=crop&w=800&q=80', count: '250+ Products' },
        { name: 'Accessories', image: 'https://images.unsplash.com/photo-1523206489230-c012c64b2b48?auto=format&fit=crop&w=800&q=80', count: '200+ Products' },
    ];
            ...
            <section className="section-padding">
                <div className="container">
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-trending product-grid">
            ...
            <section className="section-padding" style={{ background: 'var(--gray-50)' }}>
                <div className="container">
                    <div className="section-header text-center mb-12">
                        ...
                        <p className="text-muted">Explore our wide range of collections ({totalProducts}+ items)</p>
                    </div>
                    ...
                    <div className="newsletter-card">
                        <div className="newsletter-content">
                            ...
                            {newsletterStatus === 'success' ? (
                                <div className="newsletter-success"><Check size={24} /><p>Thanks for subscribing!</p></div>
                            ) : (
